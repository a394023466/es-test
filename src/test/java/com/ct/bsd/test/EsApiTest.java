...
public class EsApiTest extends CtBsdEsTestApplicationTests {


    private final static Logger LOGGER = LoggerFactory.getLogger(EsApiTest.class);
    ...
    public void getClient() {
        ...
        try {
            TransportClient client = esClientPool.borrowObject();
    ...
    public void reindexTest() throws Exception {
        TransportClient client = esClientPool.borrowObject();
        ReindexRequestBuilder destination = ReindexAction.INSTANCE.newRequestBuilder(client).source("liyuzhi")
    ...
    public void bulkProcess() throws Exception {
        ...
        BulkProcessor.Builder builder = BulkProcessor.builder(esClientPool.borrowObject(), new BulkProcessor.Listener() {
            //该方法在执行批处理之前执行
            @Override
    ...
    public void deleteByQueryListener() throws Exception {
        ...
        DeleteByQueryAction.INSTANCE.newRequestBuilder(esClientPool.borrowObject())
    ...
    public void deleteByQuery() throws Exception {
        BulkByScrollResponse response = DeleteByQueryAction
                .INSTANCE.newRequestBuilder(esClientPool.borrowObject())
    ...
    public void aggregateTest() throws Exception {
        ...
        buckets.stream().map(s -> (Terms.Bucket) s).forEach(s -> {
            ...
            Integer integer = Ints.tryParse("111");
